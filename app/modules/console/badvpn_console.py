...
class BadvpnInstaller:
    _badvpn_url = 'https://github.com/Diegoprofeta/tron_ssh/raw/master/badvpn-udpgw'
...
def badvpn_console_main():
    process_install_screen()

    console = Console('BadVPN Console', formatter=FormatterBadvpn())
